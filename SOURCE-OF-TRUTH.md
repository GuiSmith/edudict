...
`route -> asyncHandler -> controller -> service -> repository`
...
* Cada arquivo deve chamar alguma função de service
...
Será usado para padronizar entrada e saída de dados da API.

### Exemplos

* `CriarProdutoDTO`
* `CriarUsuarioDTO`
* `RegistrarInventarioDTO`
